...
free to report them through a [Meta Issue](https://github.com/yuzono/cursed-manga-extensions/issues/new?assignees=&labels=Meta+request&template=06_request_meta.yml)
...
To get the current `id` value before a name change, search the source name in the [repository JSON file](https://github.com/yuzono/cursed-manga-repo/blob/repo/index.json)
